...
png(here::here(suppl_dir, "body_sizes_methods.png"), height=9, width=13.5, res=600, units = "cm")

ggplot(MT, aes(col=method, fill=method, y=bodysize, x=group, alpha=method)) + 
